...
const initWebRouter = (app) => {
  ...
  router.get("/dailytask/record", middlewareController, homeController.rechargeAwardCollectionRecord,);
    ...
    router.get('/promotion/subrdinate', middlewareController, homeController.subordinatesPage);
    ...
    router.get("/mian/game_statistics", middlewareController, homeController.gameStatisticsPage);
    ...
    // admin
    router.get('/admin/manager/main', adminController.middlewareAdminController, adminController.adminmainpage); 
